package main.java.samples.mean;

import main.java.samples.topn.TopN.TopNReducer;
...
public class Mean {
    ...
    public static class MeanCombiner extends Reducer<Text, SumCount, Text, DoubleWritable> {
        ...
        public void reduce(Text key, Iterable<SumCount> values, Context context) throws IOException, InterruptedException {
            ...
            context.write(key, totalSumCount.getSum());
        }
    }
}
